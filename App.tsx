  ...
  if (!isAuthorized) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-slate-900 text-white p-4 text-center">
        ...
        <p className="text-slate-400">Пожалуйста, укажите правильный ключ доступа в URL.</p>
        <p className="text-slate-500 mt-2 text-sm">Пример: <code>?access_key=ВАШ_КЛЮЧ</code></p>
      </div>
    );
  }
